...
import { Post, Get, Patch } from '@nestjs/common/decorators/http/request-mapping.decorator';
...
export class CountryInfoController {
    ...
    handleProfileDescriptionUpload(@UploadedFiles() images, @Body() textDescription, dto ){
